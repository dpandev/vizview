  ...
  return (
    <ScrollView>
      <Text>
        ...
        ProForm VizView is licensed to You (End-User) by ProForm Cut {'&'} Shave, PLLC., located and registered at 4738 Barnes Rd, Colorado Springs, Colorado 80917, United States ("Licensor"), for use only under the terms of this License Agreement.
        ...
        The parties of this License Agreement acknowledge that the Services are not a Party to this License Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance and support thereof. ProForm Cut {'&'} Shave, PLLC., not the Services, is solely responsible for the Licensed Application and the content thereof.

        This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest Apple Media Services Terms and Conditions and Google Play Terms of Service ("Usage Rules"). ProForm Cut {'&'} Shave, PLLC. acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.

        ProForm VizView when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. ProForm VizView is to be used on devices that operate with Apple's operating systems ("iOS" and "Mac OS") or Google's operating system ("Android").
        ...
        ProForm VizView ("Licensed Application") is a piece of software created to facilitate visitor management for the ProForm Cut {'&'} Shave, PLLC. — and customized for iOS and Android mobile devices ("Devices"). It is used to check in guests and provide notifications to employees of ProForm Cut {'&'} Shave, PLLC..
        ...
        2.3  You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with ProForm Cut {'&'} Shave, PLLC.'s prior written consent), sell, rent, lend, lease or otherwise redistribute the Licensed Application.

        2.4  You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with ProForm Cut {'&'} Shave, PLLC.'s prior written consent).
        ...
        4.1  ProForm Cut {'&'} Shave, PLLC. is not obligated, expressed or implied, to provide any maintenance, technical or other support for the Licensed Application.

        4.2  ProForm Cut {'&'} Shave, PLLC. and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.
        ...
        8.2  No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of ProForm Cut {'&'} Shave, PLLC.'s sphere of influence that affect the executability of the Licensed Application.

        8.3  You are required to inspect the Licensed Application immediately after installing it and notify ProForm Cut {'&'} Shave, PLLC. about issues discovered without delay by email provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been emailed within a period of __________ days after discovery.

        8.4  If we confirm that the Licensed Application is defective, ProForm Cut {'&'} Shave, PLLC. reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
        ...
        ProForm Cut {'&'} Shave, PLLC. and the End-User acknowledge that ProForm Cut {'&'} Shave, PLLC., and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User’s possession and/or use of that Licensed Application, including, but not limited to:
        ...
        ProForm Cut {'&'} Shave, PLLC.
        4738 Barnes Rd
        Colorado Springs, CO 80917
        United States
        admin@proformbarber.com


        12. TERMINATION

        The license is valid until terminated by ProForm Cut {'&'} Shave, PLLC. or by You. Your rights under this license will terminate automatically and without notice from ProForm Cut {'&'} Shave, PLLC. if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.
              

        13. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY

        ProForm Cut {'&'} Shave, PLLC. represents and warrants that ProForm Cut {'&'} Shave, PLLC. will comply with applicable third-party terms of agreement when using Licensed Application.
        ...
        ProForm Cut {'&'} Shave, PLLC. and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, ProForm Cut {'&'} Shave, PLLC., and not the Services, will be solely responsible for the investigation, defense, settlement, and discharge or any such intellectual property infringement claims.
